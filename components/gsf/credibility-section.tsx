...
export function CredibilitySection() {
  ...
  const features = [
    {
      icon: FinanceIcon,
      title: "Plazos a tus clientes",
      description: "Cuando das 30, 60 o 90 días para pagar, estás otorgando crédito comercial.",
    },
    {
      icon: ConsultIcon,
      title: "Plazos de proveedores",
      description: "Recibir términos de pago de tus proveedores es financiamiento que ya administras.",
    },
    {
      icon: EcosystemIcon,
    ...
    },
    {
      ...
      description: "Adelantos y préstamos a colaboradores son crédito que hoy no capitalizas.",
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-heading text-3xl md:text-5xl font-bold text-foreground mb-4 text-balance">
            Ya haces operaciones financieras sin saberlo
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Muchas empresas realizan actividades de financiamiento todos los días sin reconocerlas como tales, identificarlas es el primer paso para profesionalizarlas.
          </p>
        </motion.div>
