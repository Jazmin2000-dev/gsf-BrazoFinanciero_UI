...
export function CasosUsoSection() {
  ...
  const profiles = [
    ...
    },
    {
      ...
      description: "Coloca equipo y maquinaria mediante esquemas de arrendamiento rentables.",
    },
    {
      icon: AdvisorIcon,
    ...
    {
      icon: EnterpriseIcon,
      title: "Créditos de nómina",
      description: "Ofrece préstamos justos a tus colaboradores como un beneficio rentable.",
    },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-heading text-3xl md:text-5xl font-bold text-foreground mb-4 text-balance">
            Una estructura, múltiples formas de generar valor
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed">
            Un brazo financiero se adapta a las necesidades reales de tu operación. Estos son algunos de los modelos más utilizados.
          </p>
        </motion.div>
